...
namespace ECommerce.Backend.Migrations
{
    ...
    [Migration("20210412100201_SeedProduct")]
            ...
            modelBuilder.Entity("ECommerce.Backend.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BrandId = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2021, 4, 12, 17, 2, 0, 866, DateTimeKind.Local).AddTicks(695),
                            ...
                            UnitsInStock = 10,
                            UnitsOnOrder = 0,
                            UpdatedDate = new DateTime(2021, 4, 12, 17, 2, 0, 867, DateTimeKind.Local).AddTicks(2011)
                        });
                });
